  ...
  return (
    ...
    <>
      ...
      <div style={{ height: "150px" }} className='  container border w-50'>
        ...
        <div className='float-right overflow-hidden text-monospace'>
          <div className='float-right'>

            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="16" fill="blue" className="bi bi-check-circle-fill" viewBox="0 0 16 16">
        ...
        <div className=' d-flex justify-content-center'>
          <h5> {balance}</h5>
          <svg fill='black' width="30" height="24" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg"><title>Ethereum icon</title><path d="M11.944 17.97L4.58 13.62 11.943 24l7.37-10.38-7.372 4.35h.003zM12.056 0L4.69 12.223l7.365 4.354 7.365-4.35L12.056 0z" /></svg>
