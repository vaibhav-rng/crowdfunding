...
function Projectheader() {
    ...
    return (
        <>
            ...
            {navBarCol.curr === "1" ? <Basic handleChanges={handleChanges} basicState={basicState}  setBasicState={setBasicState} /> : null}
            {navBarCol.curr === "2" ? <Story /> : null}
            {navBarCol.curr === "3" ? <Milestones /> : null}
            {navBarCol.curr === "4" ? <Rewards /> : null}
            {navBarCol.curr === "5" ? <Payement /> : null}
            {navBarCol.curr === "7" ? <Preview basicState={basicState}  /> : null}
